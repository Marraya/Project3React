          ...
          <MDBCard collection className="z-depth-1-half">
            <div className="view zoom">
              ...
              <div className="stripe dark">
                <a href="#!">
                  <p>
                    {props.commerce_category1} <MDBIcon icon="angle-right" />
                  </p>
                </a>
              </div>
            </div>
          ...
          <MDBCard collection className="z-depth-1-half">
            <div className="view zoom">
              ...
              <div className="stripe dark">
                <a href="#!">
                  <p>
                  {props.commerce_category2} <MDBIcon icon="angle-right" />
                  </p>
                </a>
              </div>
            </div>
          ...
          <MDBCard collection className="z-depth-1-half">
            <div className="view zoom">
              ...
              <div className="stripe dark">
                <a href="#!">
                  <p>
                  {props.commerce_category3} <MDBIcon icon="angle-right" />
                  </p>
                </a>
              </div>
            </div>
          ...
          <MDBCard collection className="z-depth-1-half">
            <div className="view zoom">
              ...
              <div className="stripe dark">
                <a href="#!">
                  <p>
                  {props.commerce_category4} <MDBIcon icon="angle-right" />
                  </p>
                </a>
              </div>
            </div>
